/**
 * Старт запроса на получение списка команд.
 */
export const GET_TEAMS_START = "GET_TEAMS_START";

/**
 * Успешное выполнение запроса на получение списка команд.
 */
export const GET_TEAMS_SUCCESS = "GET_TEAMS_SUCCESS";

/**
 * Неуспешное выполнение запроса на получение списка команд.
 */
export const GET_TEAMS_FAILURE = "GET_TEAMS_FAILURE";

/**
 * Старт запроса на получение списка сотрудников.
 */
export const GET_EMPLOYEES_START = "GET_EMPLOYEES_START";

/**
 * Успешное выполнение запроса на получение списка сотрудников.
 */
export const GET_EMPLOYEES_SUCCESS = "GET_EMPLOYEES_SUCCESS";

/**
 * Неуспешное выполнение запроса на получение списка сотрудников.
 */
 ...
 */
export const UPDATE_POSITION_LOAD_START = "UPDATE_POSITION_LOAD_START";

/**
 * Успешное выполнение запроса на изменение показателя загрузки сотрудника применительно к позиции.
 */
export const UPDATE_POSITION_LOAD_SUCCESS = "UPDATE_POSITION_LOAD_SUCCESS";
...
/**
 * Успешное выполнение запроса на изменение команды.
 */
